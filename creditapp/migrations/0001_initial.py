    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_mode', models.CharField(choices=[('cash', 'Cash'), ('gpay', 'G-pay'), ('phonepe', 'Phonepe'), ('imps', 'IMPS'), ('neft', 'NEFT'), ('rtgs', 'RTGS'), ('debit-card', 'Debit Card'), ('credit-card', 'Credit Card')], default='cash', max_length=11)),
